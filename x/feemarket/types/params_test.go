...
func (suite *ParamsTestSuite) TestParamsValidate() {
	testCases := []struct {
		...
		{
			"valid",
			NewParams(true, 7, 3, 2000000000, int64(544435345345435345), sdkmath.LegacyNewDecWithPrec(20, 4), DefaultMinGasMultiplier, DefaultGasLimitPerBlock, DefaultMaxBaseFee),
			false,
		},
		{
			"empty",
		...
		},
		{
			...
			NewParams(true, 0, 3, 2000000000, int64(544435345345435345), sdkmath.LegacyNewDecWithPrec(20, 4), DefaultMinGasMultiplier, DefaultGasLimitPerBlock, DefaultMaxBaseFee),
			true,
		},
		{
			"invalid: min gas price negative",
			NewParams(true, 7, 3, 2000000000, int64(544435345345435345), sdkmath.LegacyNewDecFromInt(sdkmath.NewInt(-1)), DefaultMinGasMultiplier, DefaultGasLimitPerBlock, DefaultMaxBaseFee),
			true,
		},
		{
			"valid: min gas multiplier zero",
			NewParams(true, 7, 3, 2000000000, int64(544435345345435345), DefaultMinGasPrice, sdkmath.LegacyZeroDec(), DefaultGasLimitPerBlock, DefaultMaxBaseFee),
			false,
		},
		{
			"invalid: min gas multiplier is negative",
			NewParams(true, 7, 3, 2000000000, int64(544435345345435345), DefaultMinGasPrice, sdkmath.LegacyNewDecWithPrec(-5, 1), DefaultGasLimitPerBlock, DefaultMaxBaseFee),
			true,
		},
		{
			"invalid: min gas multiplier bigger than 1",
			NewParams(true, 7, 3, 2000000000, int64(544435345345435345), sdkmath.LegacyNewDecWithPrec(20, 4), sdkmath.LegacyNewDec(2), DefaultGasLimitPerBlock, DefaultMaxBaseFee),
			true,
		},
	}
