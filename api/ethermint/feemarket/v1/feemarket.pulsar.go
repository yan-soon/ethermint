...
var (
	...
	fd_Params_gas_limit_per_block         protoreflect.FieldDescriptor
	fd_Params_max_base_fee                protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_gas_limit_per_block = md_Params.Fields().ByName("gas_limit_per_block")
	fd_Params_max_base_fee = md_Params.Fields().ByName("max_base_fee")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.GasLimitPerBlock != "" {
		value := protoreflect.ValueOfString(x.GasLimitPerBlock)
		if !f(fd_Params_gas_limit_per_block, value) {
			return
		}
	}
	if x.MaxBaseFee != "" {
		value := protoreflect.ValueOfString(x.MaxBaseFee)
		if !f(fd_Params_max_base_fee, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "ethermint.feemarket.v1.Params.gas_limit_per_block":
		return x.GasLimitPerBlock != ""
	case "ethermint.feemarket.v1.Params.max_base_fee":
		return x.MaxBaseFee != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "ethermint.feemarket.v1.Params.gas_limit_per_block":
		x.GasLimitPerBlock = value.Interface().(string)
	case "ethermint.feemarket.v1.Params.max_base_fee":
		x.MaxBaseFee = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ethermint.feemarket.v1.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ethermint.feemarket.v1.Params.gas_limit_per_block":
		panic(fmt.Errorf("field gas_limit_per_block of message ethermint.feemarket.v1.Params is not mutable"))
	case "ethermint.feemarket.v1.Params.max_base_fee":
		panic(fmt.Errorf("field max_base_fee of message ethermint.feemarket.v1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ethermint.feemarket.v1.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.MaxBaseFee) > 0 {
			i -= len(x.MaxBaseFee)
			copy(dAtA[i:], x.MaxBaseFee)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.MaxBaseFee)))
			i--
			dAtA[i] = 0x52
		}
		if len(x.GasLimitPerBlock) > 0 {
			i -= len(x.GasLimitPerBlock)
			copy(dAtA[i:], x.GasLimitPerBlock)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.GasLimitPerBlock)))
			i--
			dAtA[i] = 0x4a
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 9:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field GasLimitPerBlock", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.GasLimitPerBlock = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 10:
				if wireType != 2 {
				...
				x.MaxBaseFee = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type Params struct {
	...
	GasLimitPerBlock string `protobuf:"bytes,9,opt,name=gas_limit_per_block,json=gasLimitPerBlock,proto3" json:"gas_limit_per_block,omitempty"`
	// Sets the maximum base fee for evm.
	// Base Fee will not increase pass this value regardless how congested the network is.
	MaxBaseFee string `protobuf:"bytes,10,opt,name=max_base_fee,json=maxBaseFee,proto3" json:"max_base_fee,omitempty"`
}
...
func (x *Params) GetGasLimitPerBlock() string {
	if x != nil {
		return x.GasLimitPerBlock
	}
	return ""
...
func (x *Params) GetMaxBaseFee() string {
	if x != nil {
		return x.MaxBaseFee
	}
	return ""
...
var file_ethermint_feemarket_v1_feemarket_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbe, 0x04, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	,
